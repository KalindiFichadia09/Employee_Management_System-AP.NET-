            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="table-responsive">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered text-center align-middle" OnRowCommand="GridView1_RowCommand">
                            <Columns>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            Full Name :
                                            <asp:TextBox ID="Emp_Full_Name" runat="server" class="form-control" MaxLength="100" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            Father Name : 
                                            <asp:TextBox ID="Emp_Father_Name" runat="server" class="form-control" MaxLength="100" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            Mother Name :
                                            <asp:TextBox ID="Emp_Mother_Name" runat="server" class="form-control" MaxLength="100" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Emp_Adhar_Number" runat="server" MaxLength="12" TextMode="Number" class="form-control" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Emp_Mobile" runat="server" TextMode="Phone" MaxLength="10" class="form-control" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Emp_Email" TextMode="Email" runat="server" MaxLength="100" class="form-control" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Emp_Company_Email" runat="server" class="form-control" MaxLength="100" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Emp_Password" runat="server" class="form-control" MaxLength="20" placeholder="Enter Password"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="btn-set">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Emp_Pincode" runat="server" class="form-control" MaxLength="6" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <asp:Label ID="Label12" runat="server" Text="Emergency number"></asp:Label>
                                            <asp:TextBox ID="Emp_Emergency_no" TextMode="Phone" runat="server" MaxLength="10" class="form-control" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="btn-set">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Emp_Account_Holder_Name" runat="server" MaxLength="100" class="form-control" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <asp:Label ID="Label14" runat="server" Text="Bank Name"></asp:Label>
                                            <asp:TextBox ID="Emp_Bank_Name" runat="server" class="form-control" MaxLength="100" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Emp_Bank_IFSC_Code" runat="server" class="form-control" MaxLength="12" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Emp_Bank_Code" runat="server" class="form-control" MaxLength="10" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <asp:Label ID="Label21" runat="server" Text="Branch Name"></asp:Label>
                                            <asp:TextBox ID="Emp_Branch_Name" runat="server" class="form-control" MaxLength="250" placeholder="Enter Full Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="btn-set">
